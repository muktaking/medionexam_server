...
CoursesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([course_repository_1.CourseRepository, user_repository_1.UserRepository, exam_repository_1.ExamRepository, routine_repository_1.RoutineRepository]),
