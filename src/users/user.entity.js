...
var Faculty;
(function (Faculty) {
    Faculty[Faculty["all"] = 0] = "all";
    Faculty[Faculty["basic"] = 1] = "basic";
    Faculty[Faculty["medicine"] = 2] = "medicine";
    Faculty[Faculty["surgery"] = 3] = "surgery";
    Faculty[Faculty["gynecology"] = 4] = "gynecology";
    Faculty[Faculty["paediatrics"] = 5] = "paediatrics";
